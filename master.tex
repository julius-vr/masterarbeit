...
We begin by giving a brief introduction to PL intersection homology theory.
...
C_i(X) := colim \ C_i^T(X),
\end{align*}
where the colimit ranges over all triangulations of the PL structure of $X$, with respect to the canonical maps. For any $i$, the simplicial boundary maps (see. \cite{hatcher}, ch.2)
\begin{align*}
